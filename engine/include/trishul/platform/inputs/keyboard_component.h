...
namespace trishul::inputs
{
    ...
    class keyboard_component final: public input_component
    {
    public:
        ...
        keyboard_component(keyboard_component&&)      = delete;

        keyboard_component& operator=(const keyboard_component&) = delete;
        keyboard_component& operator=(keyboard_component&&)      = delete;
